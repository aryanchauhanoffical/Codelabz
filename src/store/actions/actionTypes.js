...
export const TUTORIAL_MEDIA_UPLOAD_START = "TUTORIAL_MEDIA_UPLOAD_START";
export const TUTORIAL_MEDIA_UPLOAD_SUCCESS = "TUTORIAL_MEDIA_UPLOAD_SUCCESS";
export const TUTORIAL_MEDIA_UPLOAD_FAIL = "TUTORIAL_MEDIA_UPLOAD_FAIL";

export const TUTORIAL_MEDIA_DELETE_START = "TUTORIAL_MEDIA_DELETE_START";
export const TUTORIAL_MEDIA_DELETE_SUCCESS = "TUTORIAL_MEDIA_DELETE_SUCCESS";
export const TUTORIAL_MEDIA_DELETE_FAIL = "TUTORIAL_MEDIA_DELETE_FAIL";
